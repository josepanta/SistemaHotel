                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="form-group col-sm-4">
                        ...
                        <input id="letra_numero" name="letra_numero" type="text" class="form-control {{ $errors->has('letra_numero') ? ' is-invalid' : '' }}" placeholder="Letra - Numero" value="{{ old('letra_numero') }}">
                        @error('letra_numero')
