...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tipos de Reservas</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('home') }}">Inicio</a></li>
              <li class="breadcrumb-item active">Tipos de Reservas</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Lista de Tipos de Reservas</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
  ...
  $(function () {
    $("#tipos_reservas_table").DataTable({
      ...
      "buttons": [
        {
          'text': "Agregar",
          'action': function(){
            window.location.href = "{{ route('tipo_reservas.create') }}";
          }
        }
      ...
      "initComplete": function(){
        $("#tipos_reservas_table").DataTable().buttons().container().appendTo('#tipos_reservas_table_wrapper .col-md-6:eq(0)')
      }
    });
  });
</script>
