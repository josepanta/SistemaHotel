                            ...
                            <div class="modal-body">
                              <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <select id="tipo_agregar" class="form-control select" disabled>
                                        <option disabled selected>Selecciona</option>
                                        @foreach($tipos_habitaciones as $tipo_habitacione)
                                          @if($tipo_habitacione->id == old('tipo_habitacione_id'))
                                            <option value="{{ $tipo_habitacione->id }}">{{ $tipo_habitacione->nombre }}</option>
                                          @else
                                            <option value="{{ $tipo_habitacione->id }}">{{ $tipo_habitacione->nombre }}</option>
                                          @endif
                                        @endforeach
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input id="cantidad_agregar"type="number" class="form-control" min="0" step="1" disabled>
                                </div>
                                <div class="form-group col-sm-6">
                            ...
                            <div class="modal-body">
                              <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <select id="tipo_editar" class="form-control select">
                                        <option disabled selected>Selecciona</option>
                                        @foreach($tipos_habitaciones as $tipo_habitacione)
                                          @if($tipo_habitacione->id == old('tipo_habitacione_id'))
                                            <option value="{{ $tipo_habitacione->id }}">{{ $tipo_habitacione->nombre }}</option>
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input id="cantidad_editar"type="number" class="form-control" min="0" step="1">
                                </div>
                                <div class="form-group col-sm-6">
...
<script>
  ...
  $(document).ready(function(){
      ...
      $("#nav_item_option_crear_reserva").addClass("active");
  }); 
  
  //Agregar de Modal
  var habitacionesLibres;
  $("#agregar_tabla").click(function(){
    crear_alert("Selecciona la cantidad, tipo y fecha en las que requieras las habitaciones.", "info");
  });

  $("#fecha_inicio_agregar, #fecha_fin_agregar, #cantidad_agregar").change(function(){
    ...
    if($("#cantidad_agregar").val().length !== 0){
      $.each(habitacionesLibres, function(i, item){
          $("#tipo_agregar").append("<option value = "+ item.id +">"+ item.letra_numero +"</option>");
      });
      $("#tipo_agregar").prop("disabled", false); 
    }
  });
